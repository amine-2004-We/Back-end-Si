...
/**
 * Handles validation for updating an existing Unit.
 */
class UpdateUnitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'partner_code' => ['required', 'string', 'max:255', Rule::unique('units', 'partner_code')->ignore($unit->id)],
            ...
            'classes.*.id' => [
                'sometimes',
                'integer',
                Rule::exists('class', 'id')->where('unit_id', $unit->id)
            ],
