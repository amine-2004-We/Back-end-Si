...
class UpdateGrantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['sometimes', Rule::in(['En attente', 'Partiellement reçue', 'Reçue intégralement', 'Clôturée'])],
            ...
            'remove_payment_schedule' => 'sometimes|string|in:true,false',
            'remove_proof_document' => 'sometimes|string|in:true,false',
    ...
    public function messages(): array
    {
        return [
            ...
            'received_dates.required' => 'Les dates reçues sont obligatoires.',
            'received_dates.*.required' => 'Toutes les dates reçues sont obligatoires.',
            'received_dates.*.date' => 'Chaque date reçue doit être une date valide.',
            'received_dates.array' => 'Les dates reçues doivent être fournies sous forme de tableau.',
