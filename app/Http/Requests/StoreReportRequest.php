...
class StoreReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'attachment_path' => 'nullable|file|mimes:jpg,jpeg,png,pdf,doc,docx|max:2048', // Adjust file types and size as needed
            'attachment_path.*' => 'file|mimes:jpg,jpeg,png,pdf,doc,docx|max:2048', // Adjust file types and size as needed
    ...
    public function messages(): array
    {
        return [
            ...
            'creator_id.required' => 'L\'ID du créateur est requis.',
