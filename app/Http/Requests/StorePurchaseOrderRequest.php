...
class StorePurchaseOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'total_amount_ttc' => ['required', 'numeric', 'min:0'],
            'currency'         => ['required', Rule::in(['MAD', 'EUR', 'USD'])],
            'payment_method'   => ['required', Rule::in(['transfer', 'check', 'cash'])],

            'delivery_lead_time_days' => ['nullable', 'integer', 'min:0'],

            'terms_file'   => ['nullable', 'file', 'mimes:pdf,doc,docx', 'max:5120'],
            'terms_file_path' => ['prohibited'],
    ...
    public function messages(): array
    {
        return [
            ...
            'issuer_id.required' => 'L’émetteur est requis.',
            ...
            'total_amount_ttc.required' => 'Le montant TTC est requis.',
            ...
            // ✅ File messages
            'terms_file.file'  => 'Le fichier des conditions doit être un fichier.',
            'terms_file.mimes' => 'Le fichier des conditions doit être au format PDF, DOC ou DOCX.',
            'terms_file.max'   => 'Le fichier des conditions ne doit pas dépasser 5 Mo.',
            'terms_file_path.prohibited' => 'Le chemin du fichier ne peut pas être fourni directement.',
        ];
    }
}
