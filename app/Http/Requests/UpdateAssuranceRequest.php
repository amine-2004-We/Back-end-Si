...
class UpdateAssuranceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'personne_assuree_type' => ['sometimes', 'string', Rule::in(['App\Models\External', 'App\Models\Candidate'])],
            'personne_assuree_id' => ['sometimes', 'integer', $personneExistsRule],
            'insurance_type' => ['sometimes', 'required', Rule::in(['CNSS', 'AMO', 'Retraite complémentaire'])],
            'insurance_organization' => ['sometimes', 'required', 'string', 'max:255'],
            'affiliation_date' => ['sometimes', 'required', 'date'],
