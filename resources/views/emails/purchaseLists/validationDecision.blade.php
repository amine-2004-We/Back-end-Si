    ...
    <tr>
        <td style="padding: 20px 30px;">
            ...
            <p style="font-size: 15px; color: #333;">
                Bonjour,
                <br><br>
                @if ($status === 'sent_for_quote')
                    <p>Votre liste d'achats N° {{ $purchaseList->purchase_list_id }} a été validée.</p>
                @elseif ($status === 'closed')
                    <p>Votre liste d'achats N° {{ $purchaseList->purchase_list_id }} a été rejetée.</p>
                @endif
            </p>
